...
def get_daily_analysis_repository(db: Annotated[AsyncDatabase, Depends(get_db)]) -> DailyAnalysisRepository:
    """Dependency to get daily analysis repository."""
    return DailyAnalysisRepository(db)


def get_daily_entry_repository(db: Annotated[AsyncDatabase, Depends(get_db)]) -> DailyEntryRepository:
    """Dependency to get daily entry repository."""
    return DailyEntryRepository(db)


def get_memory_repository(db: Annotated[AsyncDatabase, Depends(get_db)]) -> MemoryRepository:
    """Dependency to get memory repository."""
...
def get_prompt_log_repository(db: Annotated[AsyncDatabase, Depends(get_db)]) -> PromptLogRepository:
    """Dependency to get prompt log repository."""
